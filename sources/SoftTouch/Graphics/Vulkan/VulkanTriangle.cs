...
namespace SoftTouch
{
    public class VulkanGame : IGame
    {
        ...
        {
            var vertShaderCode = LoadEmbeddedResourceBytes("VulkanTriangle.shader.vert.spv");
            var fragShaderCode = LoadEmbeddedResourceBytes("VulkanTriangle.shader.frag.spv");
